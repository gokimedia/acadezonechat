              ...
              <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                ...
                <nav className="mt-5 flex-1 px-2 space-y-1">
                  <Link href="/admin/dashboard">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/dashboard')}`}>
                  ...
                  <Link href="/admin/chatbot">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/chatbot')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/messages">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/messages')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/departments">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/departments')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/courses">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/courses')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/campaigns">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/campaigns')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/users">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/users')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/statistics">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/statistics')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <Link href="/admin/embed">
                    <a className={`group flex items-center px-2 py-2 text-sm font-medium rounded-md ${isActive('/admin/embed')}`}>
                      <svg className="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
